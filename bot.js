...
app.get("/", (request, response) => {
  console.log(Date.now() + "Yakup Sonoyuncu | Sonoyuncu - TR");
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 's!js') {  // İstediğiniz Komut
      if(!msg.member.roles.find("name", "JavaScript")){
       msg.member.addRole("723124340312244264") //Rolü bir yerde bahsedin sonra sağ tıklayıp İD'sini alın
