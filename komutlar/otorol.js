...

{
  ...
  if (message.guild.member(message.author.id).hasPermission(0x8))

    {
      ...
      if (!mentionedRole) return message.channel.send("**Doğru Kullanım = s!otorol @<roladı> #<metinkanalı>**".then(msg => msg.delete(5000)));
